...
public class fastspawner : MonoBehaviour
{
    ...
    public float initialMinSpawnDelay = 2f;  // Initial minimum spawn delay in seconds
    public float initialMaxSpawnDelay = 3f;  // Initial maximum spawn delay in seconds
    public float scaledMinSpawnDelay = 1f;   // Scaled minimum spawn delay after 5 minutes
    public float scaledMaxSpawnDelay = 2f;   // Scaled maximum spawn delay after 5 minutes
